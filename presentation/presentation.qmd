...
- **U.S. Census (ACS 5-Year)**
  - Education, Vacancy Rates, Family Household Share, Percent White, Median Household Income
...
::: columns
::: column
![](bathrooms.png){height="35vh"}
:::
::: column
![](bedrooms.png){height="35vh"}
:::
:::

::: columns
::: column
![](area.png){height="35vh"}
:::
::: column
![](age.png){height="35vh"}
:::
...
::: column
### **Key Insight**
- The model struggles most in **high-value and low-value neighborhoods**; in other words, the extremes of the home sale price distribution.
- **Over-predicted (red):** Center City, Northwest Philly, Fishtown, South Philly  
  → Homes sell for **less than the model expects**
- **Under-predicted (blue):** Economically underserved neighborhoods  
  → Homes sell for **more than predicted**
...
**Model Accuracy:** RMSE = 0.487 (log scale) 
- On average, the percent difference is 48.7% between expected and true logged housing prices. 


**Model Fit:** R² = 0.635 (0.682 with K-fold CV) 
- 63.5% of the variance in log(sales price) is explained by our model.
