...
```{r}
Housingprice_coords <- st_coordinates(phl_sales_final_sf_final)
school_coords<- st_coordinates(philly_schools_sf_final)

nn_result <- get.knnx(data = school_coords, query = Housingprice_coords, k = 5)
```
