...
phl_sales_final <- phl_sales_clean |>
  filter(
    ...
    sale_price < quantile(phl_sales_clean$sale_price, 0.99, na.rm = TRUE),
    # Remove bathrooms > 7
